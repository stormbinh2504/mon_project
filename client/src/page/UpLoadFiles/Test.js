...
//   const [searchidVBD, setSearchidVBD] = useState("60c0e519cb3cdb3a9cef5745");
//   const [filteridVanBanDen, setfilteridVanBanDen] = useState(details);
//   const [vanbandenLDId, setvanbandenLDId] = useState([]);

//   // useEffect(() => {
//   //   setfilteridVanBanDen(
//   //     vanbandenLDId.filter((country) =>{
//   //       return country.vanBanDenId == searchidVBD}
//   //     )
//   //   );
//   // }, [search, vanbandenId]);

//   var details = vanbandenId.filter((product, index) => {
//     return product._id === searchidVBD
//   })
...
//   console.log("vanbandenLDId", vanbandenLDId)
//   console.log("filteridVanBanDen", filteridVanBanDen)
...
//           } < /td> <
//           td > {
//             item.coQuanBanNganhId.tenCoQuan
//           } < /td> <
//           td > {
//             item.nhanVienId.tenNhanVien
//           } < /td> <
//           td > {
//             item.trangThai
//           } < /td> <
...
//           }
//           loaiVanBan = {
//             item.loaiVanBanId.loaiVanBan
//           }
//           tenBoPhan = {
//             item.boPhanId.tenBoPhan
//           }
//           taiLieu = {
//             item.taiLieu
//           }
