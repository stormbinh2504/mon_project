...
import PaginationBCTKVT from "../pagination/PaginationN2/PaginationBCTKVT.js";
import Sidebarvanthu from "../../components/layout/Sidebarvanthu";



const BaoCaoThongKeVanThu = () => {
  ...
  return (
    <React.Fragment>
      ...
      <div id="content">
        <Sidebarvanthu />
      <PaginationBCTKVT></PaginationBCTKVT>
      </div>
    </React.Fragment>
  );
};

export default BaoCaoThongKeVanThu;
