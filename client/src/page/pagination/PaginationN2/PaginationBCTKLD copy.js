  ...
  useEffect(() => {
    setfilterTrangthai(
      congvieclanhdaoId.filter((country) =>
        country.trangThaiLanhDao.toLowerCase().includes(searchTrangthai.toLowerCase())
      )
    );
          ...
          <div className="header-content ">
            ...
            />
              ...
              <div className="export-csv">
                <ExportReactCSV csvData={congvieclanhdaoId} fileName="congvieclanhdao.xls" />
              </div>
            ...
            <Table style={{ width: "100%" }} striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th className="width-120px">Thời hạn xử lí</th>
