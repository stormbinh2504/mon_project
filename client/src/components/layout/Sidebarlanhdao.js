...
{/* Văn bản đến */}
            ...
            <ul className='sub-menu' id="drop-vanbanden" >   
                <li>
                    <Link className='color-white item-dm pd-left-20' to='lanhdao/quanlyvanbandenlanhdao'>
                        Quản lý văn bản đến
                    </Link>
                </li>
                <li>
                    <Link className='color-white item-dm pd-left-20' to='lanhdao/quanlycongvieclanhdao'>
                        Quản lý CV văn bản đến
                    </Link>
                </li>
                <li>
                    <Link className='color-white item-dm pd-left-20' to='lanhdao/baocaothongkelanhdao'>
                        Báo cáo văn bản đến
                    </Link>
                </li>
            </ul>
